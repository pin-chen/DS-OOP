...
{
	cout<<"．1・, ．2・, ．3・, ．4・: curve pairs " <<'\n';
	cout<<"．c・: sort the sample points about the reference point (L,0)" <<'\n';
	cout<<"．r・: cycle the regions. And use the current region for generating the sample points" <<'\n';
	cout<<"．s・: show student information" <<'\n';
